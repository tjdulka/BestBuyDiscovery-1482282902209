...
Fetcher.prototype.queryPath = function queryPath(queryId) {
  const environmentId = process.env.DISCOVERY_ENVIRONMENT || '83d1a781-66a2-46ca-8449-e13c73269e78';
  const collectionId = process.env.DISCOVERY_COLLECTION || '8144d303-8dee-46eb-8ed4-04338cae4e7c';
